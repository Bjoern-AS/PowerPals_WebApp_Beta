    ...
    items: [
      {
        ...
        renderItem: (
          <Item
            ...
            item="item-1"
            slideToItem={slide}
            title={"Energiewende Gemeinsam Starten"}
            subtitle={"Der größte Hebel im Kampf gegen die  Klimakrise ist es, Energie aus nachhaltigen Quellen zu beziehen."}
          />
        ),
      },
      {
        ...
        renderItem: (
          <Item
            ...
            item="item-2"
            slideToItem={slide}
            title={"Helfen. Aber wie?"}
            subtitle={"Kein eigenes Dach für Solarenergie? Unsicher, wie du einen Unterschied machen kannst? Kein Problem! Mit PowerPal wirst du Teil der Lösung"}
          />
        ),
      },
      {
        ...
        renderItem: (
          <Item
            ...
            item="item-3"
            slideToItem={slide}
            title={"EEG Gründen und Profitieren"}
            subtitle={"Gemeinsam Strom aus erneuerbaren Quellen produzieren und konsumieren - regional, preisstabil und unabhängig von konventionellen Energieversorgen."}
          />
        ),
      },
    ],
